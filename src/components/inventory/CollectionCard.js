...
export const CollectionCard = ({
  ...
  const searchTrue = collection.collectionName
    .toLowerCase()
  ...
  if (searchTrue) {
    const fontSizeH4 =
      collection.collectionName.length > 50
        ? "10px"
        : { xs: "12px", sm: "14px", md: "14px", lg: "16px", xl: "14px" };
    const fontSizeP2 =
      collection.collectionName.length > 50
        ? "10px"
        : { xs: "10px", sm: "10px", md: "12px", lg: "12px", xl: "14px" };

    returnValue = (
      <Grid item xs={12} md={6} lg={4} xl={3} onClick={() => {}}>
        <NextLink
          href={`/inventory/slot/${slot.slotId}/collection/${collection.collectionId}`}
          passHref
          legacyBehavior
        >
          <Card
          ...
          >
            ...
            <Typography
              variant="h4"
              sx={{ lineHeight: "25px", fontSize: fontSizeH4 }}
            >
